  ...
  export default {
    ...
    methods: {
      ...
      addToShopCar() {
        ...
        var goodsinfo= {id:this.id,count:this.selectedCount,price:this.goodsinfo.sell_price,selected:true} //拼接处一个要保存到 store的对象

        this.$store.commit('addtocar',goodsinfo)  //调用store中的mutition方法  将对象添加到store中
      },
      beforeEnter(el) {
